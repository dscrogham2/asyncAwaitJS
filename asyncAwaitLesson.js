...
2. I bought fava beans because the
y were on sale.                   
$                                 
...
async function hostDinnerParty() {
  try {
    let resolveValue = await cookBeanSouffle(resolveValue);
...
$ node app.js                     
ReferenceError: resolveValue is no
t defined                         
    at hostDinnerParty (/home/ccus
er/workspace/async-await-error-han
dling/app.js:6:46)                
    at Object.<anonymous> (/home/c
cuser/workspace/async-await-error-
handling/app.js:15:1)            
...
32)                               
    at tryModuleLoad (module.js:44
7:12)                             
    at Function.Module._load (modu
le.js:439:3)                      
    at Module.runMain (module.js:6
05:10)                            
    at run (bootstrap_node.js:427:
7)                                
